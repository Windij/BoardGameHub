...
class GameSession(SqlAlchemyBase, SerializerMixin):
    ...
    creator = orm.relationship('User', foreign_keys=[creator_id], back_populates='created_sessions')
    participants = orm.relationship('User', secondary=session_participants)
